...
export default function Home() {
  ...
  const handleCourseCreationSuccess = useCallback(
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-black text-white overflow-y-auto">
        ...
        {/* ============================================================= */}
        {/* Uncomment below to make the button ALWAYS visible in header:  */}
        {/* <div className="flex justify-end max-w-6xl mx-auto pt-4 pr-8">
          <Link href="/speech-feedback">
            <span className="inline-block px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition">
              Try Conversational Feedback Demo
            </span>
          </Link>
        </div> */}
        {/* ============================================================= */}
                ...
                {!hasTeachingCourses && !hasLearningCourses ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <div className="flex justify-center gap-4">
                      ...
                      {/* ---- Conversational Feedback Link ---- */}
                      <Link href="/resume-questions">
                        <span className="px-6 py-3 bg-blue-600 hover:bg-blue-800 text-white text-sm font-medium rounded-full transition inline-block cursor-pointer">
                          Try Conversational Feedback
                        </span>
                      </Link>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {(activeTab === 'teaching' ? teachingCourses : learningCourses).map((course) => (
                    <CourseCard
                      ...
                      course={{
                        ...course,
                        title: course.org?.slug
                          ? `@${course.org.slug}/${course.title}`
                          : course.title
                      }}
                    />
                  ))}
